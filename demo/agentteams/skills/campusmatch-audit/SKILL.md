...
Call `campusmatch.audit_export` with `schema_version=1.0`, the assigned `task_id`, a stable `idempotency_key`, and the actual consent, trace, and human-approval states.
